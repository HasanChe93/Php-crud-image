...
<div class="container bg-light text-success mt-5">
    <div class="row ">
    <h1 class="col-9 px-0">Add New Employee</h1>
...
<div class="p-3 mb-2 bg-dark text-success border border-success border-opacity-100">
    ...
    <div class="text-center mt-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" value="addEmployee" name="addEmployee" class="btn btn-success btn-block">Add Employee</button>
        ...
        <a class="btn btn-outline-danger fs-4 mb-4 " href="./index.php">Return Home</a>
    </div>
</form>
</div>
